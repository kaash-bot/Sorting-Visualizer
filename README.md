...
You can setup and use SDL2 lib with your code [here](http://lazyfoo.net/tutorials/SDL/01_hello_SDL/index.php).
After setting up the SDL2 library, create a Makefile similar to the one in the repo and execute it by typing `make all`. This will create an executable called 'sort' and run it.
